# `CUDNN_jll.jl` (v8.9.7+1)

[![deps](https://juliahub.com/docs/CUDNN_jll/deps.svg)](https://juliahub.com/ui/Packages/General/CUDNN_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/7cade96ab5bb6e41099c5e46e12ec00d3fec1391/C/CUDA/CUDNN@8/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* `Platform("x86_64", "windows"; cuda = "12.0")` (`x86_64-w64-mingw32-cuda+12.0`)
