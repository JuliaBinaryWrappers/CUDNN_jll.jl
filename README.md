# `CUDNN_jll.jl` (v9.24.0+2)

[![deps](https://juliahub.com/docs/CUDNN_jll/deps.svg)](https://juliahub.com/ui/Packages/General/CUDNN_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/5eea1f7891913d3dc6e264b3aa44d09e7ba8fbc4/C/CUDA/CUDNN@9/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://developer.download.nvidia.com/compute/cudnn/redist/cudnn/windows-x86_64/cudnn-windows-x86_64-9.24.0.43_cuda13-archive.zip (SHA256 checksum: `88f72bd1ce384197cedbc68496c6052d7ff0bd9fd0b3c74470402cf737507e06`)
...
* `LibraryProduct`: `libcudnn_engines_tensor_ir`
* `LibraryProduct`: `libcudnn_ext`
